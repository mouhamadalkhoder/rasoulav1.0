...
///
let element = document.querySelector('.anii');
let position = element.getBoundingClientRect();
let elements = document.getElementsByClassName('sigma_service style-6');
...
//	if(position.top >= 0 && position.bottom <= window.innerHeight) {
   //   console.log(element);    
    ...
    // if(!(elements[0].classList.contains('animate__animated'))){
...
//          <div class="sigma_service style-6 animate__animated animate__backInRight"></div>